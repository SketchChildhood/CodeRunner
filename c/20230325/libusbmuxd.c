...
#define PACKAGE_STRING "dabing package"

#include "/usr/local/include/plist/plist.h"
...
// usbmuxd protocol
#include "/usr/local/include/usbmuxd-proto.h"
// socket utility functions
#include "/usr/local/include/libimobiledevice-glue/socket.h"
// misc utility functions
#include "/usr/local/include/libimobiledevice-glue/collection.h"
// threads
#include "/usr/local/include/libimobiledevice-glue/thread.h"
